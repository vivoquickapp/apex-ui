...
function drawToolTip(textList, offset, opts, config, context) {
  ...
  context.globalAlpha = config.toolTipOpacity;
...
function drawBackground(opts, config, context) {
  context.fillStyle = opts.backgroundColor || config.backgroundColor;
    ...
    case 'line':
      this.animationInstance = new Animation({
        ...
        onProcess: function onProcess(process) {
          drawBackground(opts, config, context);
...
var Charts = function Charts(opts) {
  ...
  this.context = opts.element.getContext('2d');
...
Charts.prototype.scrollStart = function (e) {
  if (e.touches[0] && this.opts.enableScroll === true) {
    this.scrollOption.startTouchX = e.touches[0].offsetX;
  }
};
...
Charts.prototype.scroll = function (e) {
  // TODO throtting...
  if (e.touches[0] && this.opts.enableScroll === true) {
    var _distance = e.touches[0].offsetX - this.scrollOption.startTouchX;
    var currentOffset = this.scrollOption.currentOffset;
